...
error_progress = nn.train(data[:num_train, :], labels[:num_train,:], epochs = 5000, show = 1000, goal= 0.01)

# Saving neural network to the 'neural_network.data' file
nn.save('neural_network.data')
